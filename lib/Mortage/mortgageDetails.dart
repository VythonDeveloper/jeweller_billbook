...
class MortgageDetailsUi extends StatefulWidget {
  final mortgageId;
  const MortgageDetailsUi({super.key, required this.mortgageId});

  @override
  State<MortgageDetailsUi> createState() =>
      _MortgageDetailsUiState(mortgageId: mortgageId);
}

class _MortgageDetailsUiState extends State<MortgageDetailsUi> {
  final mortgageId;
  _MortgageDetailsUiState({this.mortgageId});
  ...
  AlertDialog DeleteMortgageAlertBox() {
    return AlertDialog(
          ...
          onPressed: () async {
            ...
            await FirebaseFirestore.instance
              ...
              FirebaseFirestore.instance
                  ...
                  .doc(UserData.uid)
                  .collection('transactions')
                  .where('itemId', isEqualTo: mortgageMap['id'])
                  .get()
                  .then((value) {
                if (value.size > 0) {
                  FirebaseFirestore.instance
